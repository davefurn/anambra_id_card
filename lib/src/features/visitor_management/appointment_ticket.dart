    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ...
          '',
          style:
              Theme.of(context).textTheme.headlineLarge?.copyWith(fontSize: 24.sp),
        ),
      ),
      body: Padding(
            ...
            Row(
              children: [
                Expanded(
                  flex: 6,
                  child: InkWell(
                    onTap: () => ShowFlushBar.showSuccess(context: context, message: 'Approved, token sent to visitor'),
                    child: SpecialButton2(
                      text: 'Approve',
                      textColor: IdColors.backgroundColour,
                      height: 48.h,
                      backgroundColor: const Color(0xff00BF55),
                      borderColor: const Color(0xff00BF55),
                    ),
                  ),
                ),
                16.sbW,
                Expanded(
                  ...
                  flex: 4,
                  child: InkWell(
                     onTap: () => ShowFlushBar.showError(context: context, error: 'Declined, message sent to visitor'),
                    child: SpecialButton2(
                      text: 'Decline',
                      textColor: IdColors.failureColor,
                      height: 48.h,
                      backgroundColor: Colors.transparent,
                      borderColor: IdColors.failureColor,
                    ),
                  ),
                ),
              ],
